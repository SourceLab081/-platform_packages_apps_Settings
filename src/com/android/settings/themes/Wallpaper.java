...
import com.android.settings.themes.SystemUtils;
...
public class Wallpaper extends SettingsPreferenceFragment 
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.system_wallpaper_settings);
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.system_wallpaper_settings) {
                @Override
