...
public class BuildNumberPreferenceController extends BasePreferenceController implements
    ...
    public CharSequence getSummary() {
        String buildDisplay = BidiFormatter.getInstance().unicodeWrap(Build.DISPLAY);
        String ascpVersion = android.os.SystemProperties.get("ro.ascp.version", "");
        if (!android.text.TextUtils.isEmpty(ascpVersion)) {
            return buildDisplay + "\n" + ascpVersion;
        }
        return buildDisplay;
    }
