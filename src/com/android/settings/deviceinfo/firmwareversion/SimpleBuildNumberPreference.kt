...
class SimpleBuildNumberPreference :
    ...
    override fun getSummary(context: Context): CharSequence? {
        ...
        val buildDisplay = BidiFormatter.getInstance(isRtl).unicodeWrap(Build.DISPLAY)
        val ascpVersion = android.os.SystemProperties.get("ro.ascp.version", "")
        return if (ascpVersion.isNotEmpty()) {
            "$buildDisplay\n$ascpVersion"
        } else {
            buildDisplay
        }
