...
class DarkModeBlackThemePreference(context: Context, private val darkModeStorage: DarkModeStorage) :
    ...
    override fun storage(context: Context): KeyValueStore = blackThemeStorage

    override fun getReadPermissions(context: Context) = DarkModeBlackThemeStorage.getReadPermissions()

    override fun getWritePermissions(context: Context) = DarkModeBlackThemeStorage.getWritePermissions()
