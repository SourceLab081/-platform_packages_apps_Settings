...
public class TapScreenGesturePreferenceController extends GesturePreferenceController {
    ...
    private final String SECURE_KEY = DOZE_TAP_SCREEN_GESTURE;
        ...
        if (preference != null) {
            ...
            if (enabled) {
                summary = mContext.getString(R.string.gesture_setting_on) + " ("
                        + (Settings.Secure.getInt(resolver, Settings.Secure.DOZE_TAP_GESTURE_AMBIENT, 1) == 1
    ...
    private class SettingObserver extends ContentObserver {
        ...
        private final Uri mAmbientUri = Settings.Secure.getUriFor(Settings.Secure.DOZE_TAP_GESTURE_AMBIENT);

        private final Preference mPreference;

        SettingObserver(Preference preference) {
            super(new Handler(android.os.Looper.getMainLooper()));
