...
public class PickupGesturePreferenceController extends GesturePreferenceController {
        ...
        if (preference != null) {
            ...
            if (enabled) {
                summary = mContext.getString(R.string.gesture_setting_on) + " ("
                        + (Settings.Secure.getInt(resolver, Settings.Secure.DOZE_PICK_UP_GESTURE_AMBIENT, OFF) == ON
    ...
    private class SettingObserver extends ContentObserver {
        ...
        private final Uri mAmbientUri = Settings.Secure.getUriFor(Settings.Secure.DOZE_PICK_UP_GESTURE_AMBIENT);
